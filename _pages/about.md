...
<section id="about" class="about-section" style="max-width:800px;margin:auto;padding:2rem;font-family:'Inter',sans-serif;line-height:1.7;color:#222;">
  ...
  <p>
    My research seeks to understand the role of molecular disorder in 
    <strong>organic semiconductor materials</strong>. I combine 
    <strong>inelastic neutron scattering (INS)</strong> spectroscopy with 
    <strong>quantum chemical and condensed matter simulations</strong> to reveal how structural 
    dynamics influence charge transport and optoelectronic properties.
  </p>

  <p>
    Alongside this work, I develop <strong>polarizable force fields</strong> for TADF emitters and 
    contribute to <strong>open-source computational chemistry tools</strong>. These projects aim to 
    bridge experimental observations with atomistic simulations, providing a deeper understanding of 
    molecular interactions that govern material performance.
  </p>

  <h3 style="margin-top:1.5rem;font-size:1.2rem;">Questions That Drive My Research</h3>
  <ul style="margin-left:1.5rem;">
    <li>How can we design organic semiconductors with superior charge carrier mobility?</li>
    <li>What approaches allow polymeric materials to be simulated efficiently with minimal resources?</li>
    <li>How can disorder information be extracted directly from neutron spectroscopy data?</li>
    <li>What modeling strategies improve TADF force fields and OLED device performance?</li>
  </ul>
  ...
  <blockquote style="border-left:3px solid #ddd;padding-left:1rem;font-style:italic;color:#555;margin-top:1.5rem;">
    “Science and strategy share a common foundation — both seek clarity in complexity, and both reward those who ask better questions.”
  </blockquote>
